        ...
        <div className="glass border border-border/40 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
          ...
          {success ? (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center relative">
              ...
              <h2 className="text-xl font-bold mb-1.5 tracking-tight">Check your email</h2>
              <p className="text-muted-foreground text-xs mb-6 leading-relaxed">
                We sent a confirmation link to <strong>{email}</strong>. Click it to activate your account.
              </p>
              <Link
                href="/auth/login"
                className="text-xs font-semibold hover:underline flex items-center justify-center gap-1 group"
              >
                Go to Login <span className="group-hover:translate-x-0.5 transition-transform">→</span>
              </Link>
            </motion.div>
          ) : (
            <>
              <h1 className="text-xl font-bold text-center mb-1.5 tracking-tight">Create account</h1>
              ...
              <form onSubmit={handleRegister} className="space-y-3.5">
                ...
                <div>
                  <label className="text-[11px] font-semibold text-muted-foreground mb-1.5 block uppercase tracking-wider">Confirm Password</label>
                  <div className="relative">
                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground/70" />
                    <input
                      type="password"
