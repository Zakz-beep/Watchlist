...
const POPULAR: SearchResult[] = [
  { symbol: "BTCUSDT",  name: "Bitcoin",       assetType: "crypto", source: "binance" },
  { symbol: "ETHUSDT",  name: "Ethereum",      assetType: "crypto", source: "binance" },
  { symbol: "SOLUSDT",  name: "Solana",        assetType: "crypto", source: "binance" },
          ...
          >
            ...
            <div className="px-6 pt-4">
              ...
              <div className="flex gap-2 mt-3">
                {(["all", "yahoo", "binance", "okx"] as const).map((s) => (
                  <button
                    key={s}
                    onClick={() => setSource(s)}
                    className={cn(
